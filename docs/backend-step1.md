...
* Доступ к админке
  * Администратор (могут делать всё из с)
  ...
  * Модератор "региональный" (могут видеть и редактировать только разделы "Календарь" и "Куда пойти", но тоглько для своего региона)
